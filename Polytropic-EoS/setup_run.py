...
# input_data = np.array([[1.0,1.0,0.0054320988],[1.0,1.0,0.1358024691],[1.0,1.0,0.2661728395],[1.0,1.0,0.347654321],[1.0,1.0,0.44]])
# input_data = np.array([[1.0,0.75,0.0054320988],[1.0,0.75,0.1358024691],[1.0,0.75,0.2661728395],[1.0,0.75,0.347654321],[1.0,0.75,0.44]])
# input_data  = np.array([[0.5,0.5,0.0162962963],[0.5,0.5,0.0651851852], [0.5,0.5,0.4074074074], [0.5,0.5,0.7985185185], [0.5,0.5,1.0429629630], [0.5,0.5,1.3200000000],
#  [0.75,0.75,0.0092592593],[0.75,0.75,0.0370370370], [0.75,0.75,0.1481481481], [0.75,0.75,0.4537037037], [0.75,0.75,0.5925925926], [0.75,0.75,0.7500000000]])

# input_data  = np.array([[0.5,0.5,1.3200000000],[0.75,0.75,0.7500000000],[1,1,0.47]])
# input_data  = np.array([[1,1,0.6]])
# input_data  = []
# delta = (1.00-0.44)/(21)
# for j in range(21):
#     input_data.append([1,1,0.44+ j*delta])
...
# delta = (bhigh-blow)/(20)
# for j in range(Nn+1):
#     input_data.append([0.75,0.75, blow+ j*delta])
