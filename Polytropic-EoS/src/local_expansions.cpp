...
void obtain_H0_and_H1_ext(double l, double Omega, double n, double brel, double mu1, double xi1, std::vector<double> &H0_ext, std::vector<double> &H1_ext )
{
    ...
    H0_ext[0] = 
    z + (pow(epsilon,2)*(1197 - 22890*z + 37465*pow(z,2) + 1680*pow(Pi,2)*pow(z,2) - 20136*pow(z,3) - 3360*pow(Pi,2)*pow(z,3) - 3517*pow(z,4) + 1680*pow(Pi,2)*pow(z,4) + 5730*pow(z,5) - 489*pow(z,6) - 10080*pow(-1 + z,2)*pow(z,2)*Li_2 + 24*pow(-1 + z,2)*(-35 + 280*z + 214*pow(z,2) - 280*pow(z,3) + 35*pow(z,4))*log(1 - z) + 840*log(z) - 8400*z*log(z) + 3276*pow(z,2)*log(z) + 22008*pow(z,3)*log(z) - 25284*pow(z,4)*log(z) + 8400*pow(z,5)*log(z) - 840*pow(z,6)*log(z) - 5040*pow(z,2)*pow(log(z),2) + 10080*pow(z,3)*pow(log(z),2) - 5040*pow(z,4)*pow(log(z),2)))/(2520.*pow(-1 + z,2)*z)
    ;

//------------------
    H1_ext[0] = 
    1 + (pow(epsilon,2)*(357 + 4809*z + 5039*pow(z,2) - 1680*pow(Pi,2)*pow(z,2) - 25069*pow(z,3) + 5040*pow(Pi,2)*pow(z,3) + 47571*pow(z,4) - 5040*pow(Pi,2)*pow(z,4) - 40705*pow(z,5) + 1680*pow(Pi,2)*pow(z,5) + 14745*pow(z,6) - 1467*pow(z,7) - 10080*pow(-1 + z,3)*pow(z,2)*Li_2 + 24*pow(-1 + z,3)*(35 + 634*pow(z,2) - 560*pow(z,3) + 105*pow(z,4))*log(1 - z) + 840*log(z) - 2520*z*log(z) + 23604*pow(z,2)*log(z) - 77532*pow(z,3)*log(z) + 106092*pow(z,4)*log(z) - 68964*pow(z,5)*log(z) + 21000*pow(z,6)*log(z) - 2520*pow(z,7)*log(z) + 5040*pow(z,2)*pow(log(z),2) - 15120*pow(z,3)*pow(log(z),2) + 15120*pow(z,4)*pow(log(z),2) - 5040*pow(z,5)*pow(log(z),2)))/(2520.*pow(-1 + z,3)*pow(z,2))
    ;
...
//------------------
    ...
    H0_ext[1] = (-5*(-1 + 8*z - 8*pow(z,3) + pow(z,4) + 12*pow(z,2)*log(z)))/(32.*pow(C1,5)*z) + (pow(epsilon,2)*(125509 - 14700*pow(Pi,2) + 1434170*z + 147000*pow(Pi,2)*z - 3375767*pow(z,2) - 70140*pow(Pi,2)*pow(z,2) + 1813000*pow(z,3) - 359520*pow(Pi,2)*pow(z,3) + 460267*pow(z,4) + 429660*pow(Pi,2)*pow(z,4) - 503170*pow(z,5) - 147000*pow(Pi,2)*pow(z,5) + 45991*pow(z,6) + 14700*pow(Pi,2)*pow(z,6) + 2116800*pow(z,2)*zeta_3 - 4233600*pow(z,3)*zeta_3 + 2116800*pow(z,4)*zeta_3 - 2116800*pow(-1 + z,2)*pow(z,2)*Li_3 - 44940*log(1 - z) + 449400*z*log(1 - z) - 763980*pow(z,2)*log(1 - z) + 763980*pow(z,4)*log(1 - z) - 449400*pow(z,5)*log(1 - z) + 44940*pow(z,6)*log(1 - z) - 29400*log(z) + 1440600*z*log(z) - 403608*pow(z,2)*log(z) + 176400*pow(Pi,2)*pow(z,2)*log(z) - 1672464*pow(z,3)*log(z) - 352800*pow(Pi,2)*pow(z,3)*log(z) + 625812*pow(z,4)*log(z) + 176400*pow(Pi,2)*pow(z,4)*log(z) + 361200*pow(z,5)*log(z) - 44940*pow(z,6)*log(z) + 88200*log(1 - z)*log(z) - 882000*z*log(1 - z)*log(z) + 960120*pow(z,2)*log(1 - z)*log(z) + 1078560*pow(z,3)*log(1 - z)*log(z) - 2038680*pow(z,4)*log(1 - z)*log(z) + 882000*pow(z,5)*log(1 - z)*log(z) - 88200*pow(z,6)*log(1 - z)*log(z) - 44100*pow(log(z),2) + 441000*z*pow(log(z),2) - 749700*pow(z,2)*pow(log(z),2) + 749700*pow(z,4)*pow(log(z),2) - 441000*pow(z,5)*pow(log(z),2) + 44100*pow(z,6)*pow(log(z),2) + 176400*pow(z,2)*pow(log(z),3) - 352800*pow(z,3)*pow(log(z),3) + 176400*pow(z,4)*pow(log(z),3) - 2520*pow(-1 + z,2)*Li_2*(-35 + 280*z + 428*pow(z,2) - 280*pow(z,3) + 35*pow(z,4) - 420*pow(z,2)*log(z))))/(141120.*pow(C1,5)*pow(-1 + z,2)*z)
    ;
 ...
 //------------------
    ...
    H1_ext[1] = 
    (-5*(1 + 12*pow(z,2) - 16*pow(z,3) + 3*pow(z,4) + 12*pow(z,2)*log(z)))/(32.*pow(C1,5)*pow(z,2)) - (pow(epsilon,2)*(-154909 + 14700*pow(Pi,2) + 1891467*z - 44100*pow(Pi,2)*z - 2801035*pow(z,2) + 400260*pow(Pi,2)*pow(z,2) - 254643*pow(z,3) - 1318380*pow(Pi,2)*pow(z,3) + 3679077*pow(z,4) + 1818180*pow(Pi,2)*pow(z,4) - 3501539*pow(z,5) - 1194060*pow(Pi,2)*pow(z,5) + 1279555*pow(z,6) + 367500*pow(Pi,2)*pow(z,6) - 137973*pow(z,7) - 44100*pow(Pi,2)*pow(z,7) + 2116800*pow(z,2)*zeta_3 - 6350400*pow(z,3)*zeta_3 + 6350400*pow(z,4)*zeta_3 - 2116800*pow(z,5)*zeta_3 + 2116800*pow(-1 + z,3)*pow(z,2)*Li_3 + 44940*log(1 - z) - 134820*z*log(1 - z) + 674100*pow(z,2)*log(1 - z) - 2381820*pow(z,3)*log(1 - z) + 3909780*pow(z,4)*log(1 - z) - 3100860*pow(z,5)*log(1 - z) + 1123500*pow(z,6)*log(1 - z) - 134820*pow(z,7)*log(1 - z) - 58800*log(z) + 793800*z*log(z) + 978192*pow(z,2)*log(z) + 176400*pow(Pi,2)*pow(z,2)*log(z) - 3209256*pow(z,3)*log(z) - 529200*pow(Pi,2)*pow(z,3)*log(z) + 2298276*pow(z,4)*log(z) + 529200*pow(Pi,2)*pow(z,4)*log(z) + 476268*pow(z,5)*log(z) - 176400*pow(Pi,2)*pow(z,5)*log(z) - 858900*pow(z,6)*log(z) + 134820*pow(z,7)*log(z) - 88200*log(1 - z)*log(z) + 264600*z*log(1 - z)*log(z) - 1862280*pow(z,2)*log(1 - z)*log(z) + 6292440*pow(z,3)*log(1 - z)*log(z) - 9291240*pow(z,4)*log(1 - z)*log(z) + 6625080*pow(z,5)*log(1 - z)*log(z) - 2205000*pow(z,6)*log(1 - z)*log(z) + 264600*pow(z,7)*log(1 - z)*log(z) + 44100*pow(log(z),2) - 132300*z*pow(log(z),2) + 661500*pow(z,2)*pow(log(z),2) - 2337300*pow(z,3)*pow(log(z),2) + 3836700*pow(z,4)*pow(log(z),2) - 3042900*pow(z,5)*pow(log(z),2) + 1102500*pow(z,6)*pow(log(z),2) - 132300*pow(z,7)*pow(log(z),2) + 176400*pow(z,2)*pow(log(z),3) - 529200*pow(z,3)*pow(log(z),3) + 529200*pow(z,4)*pow(log(z),3) - 176400*pow(z,5)*pow(log(z),3) + 2520*pow(-1 + z,3)*Li_2*(35 + 848*pow(z,2) - 560*pow(z,3) + 105*pow(z,4) - 420*pow(z,2)*log(z))))/(141120.*pow(C1,5)*pow(-1 + z,3)*pow(z,2))
    ;
